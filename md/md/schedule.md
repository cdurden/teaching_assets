...
| **Wednesday, April 1**<br/>    <a href="https://app.schoology.com/assignment/2436355919" target="_parent">Efficiently Solving Inequalities</a> (<a href="../pdf/EfficientlySolvingInequalities.pdf</a>)(Download in Notability) | <ul><li>I can solve inequalities by solving a related equation and then checking which values are solutions to the original inequality.</li></ul> | <a href="https://youtu.be/hzYhzfEo7C8">Watch as many examples as you need from the video</a> (Edit: also watch <a href="https://youtu.be/df9z4oWeylI">Exercise 1</a> which I left out) for this lesson and complete the 9 Exercises on the slides. |
